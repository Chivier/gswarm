...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in profiler_pb2_grpc.py depends on"
...
def add_ProfilerServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("gswarm_profiler.ProfilerService", rpc_method_handlers)
