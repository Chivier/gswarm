...
def parse_arguments():
    ...
    parser.add_argument("--port", type=int, default=8095, help="gRPC port for profiler service (default: 8095)")
    parser.add_argument("--http-port", type=int, default=8096, help="HTTP port for API service (default: 8096)")
    parser.add_argument("--model-port", type=int, default=9010, help="Model management service port (default: 9010)")
...
def main():
    ...
    api = StandaloneStrategyAPI(model_head_url=model_head_url, profiler_head_address=profiler_head_address)
