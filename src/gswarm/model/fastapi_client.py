...
from gswarm.model.fastapi_models import (
    NodeInfo, StorageType, CopyMethod
)
...
class ModelClient:
    ...
    def copy_model(self, model_name: str, source_device: str, target_device: str,
                  keep_source: bool = True, use_pinned_memory: bool = True) -> bool:
    ...
    def serve_model(self, model_name: str, source_device: str, gpu_device: str, 
                   port: int, instance_id: Optional[str] = None,
                   config: Optional[Dict] = None) -> Tuple[bool, Optional[Dict]]:
    ...
    def serve_multiple_instances(self, model_name: str, source_device: str, 
                               gpu_device: str, num_instances: int,
                               base_port: int = 8000, 
    ...
    def load_to_gpu(self, model_name: str, source_device: str = "disk", 
                   gpu_device: str = "gpu0", port: Optional[int] = None) -> Tuple[bool, Optional[Dict]]:
    ...
    def offload_from_gpu(self, model_name: str, instance_id: str, 
                        target_device: str = "dram") -> bool:
