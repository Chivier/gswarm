...
def example_kv_storage():
    ...
    config = {
        "model_name": "llama-7b",
        "parameters": {"layers": 32, "hidden_size": 4096, "vocab_size": 32000},
        "weights": large_array,
...
def example_data_pool():
    ...
    try:
        ...
        # Create a new chunk
        print("\n2. Create Data Chunk:")
        chunk_data = {"source": "/tmp/example_data.bin", "device": "dram", "type": "input", "format": "tensor"}
        ...
        print("\n5. Transfer Chunk:")
        transfer_data = {"target_node": "node2", "target_device": "dram", "delete_source": False}
